...
class PagesController extends AbstractController
{
    ...
    public function waloude(): Response
    {
     ...
     /**
     * @Route("/etrerappele", name="etrerappele", methods={"GET"})
     */
    public function etrerappele(): Response
    {
        return $this->render('pages/etrerappele.html.twig');
    }

    /**
     * @Route("/demandeMotDePasse", name="demandeMotDePasse", methods={"GET"})
     */
    public function demandeMotDePasse(): Response
    {
        return $this->render('pages/formDemandeMotDePasse.html.twig');
    }

    /**
     * @Route("/contrat", name="contrat", methods={"GET"})
     */
    public function contrat(): Response
    {
        return $this->render('pages/contrat.html.twig');
    }
