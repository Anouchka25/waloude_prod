...
class ContratController extends AbstractController
{
    ...
    /**
     * @Route("/contratPDF", name="contrat_pdf", methods={"GET"})
     */
    public function contratPDF(ContratRepository $contratRepository): Response
    {
        return $this->render('contrat/contratPDF.html.twig', [
            'contrats' => $contratRepository->findAll(),
        ]);
    }
